...
export { default as PersonSearchResultsTopTab } from './PersonSearchResultsTopTab';
export { default as CollectionSearchResultsTopTab } from './CollectionSearchResultsTopTab';
